          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('index.php/dashboard/barang/add');?>"><i class="fa fa-circle-o"></i> Tambahkan Barang</a></li>
                <li><a href="<?php echo base_url('index.php/dashboard/transaksi/add');?>"><i class="fa fa-circle-o"></i> Tambahkan Transaksi</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="<?php echo base_url('index.php/dashboard/barang');?>">
            ...
            <li class="treeview">
              <a href="<?php echo base_url('index.php/dashboard/transaksi');?>">
            ...
            <li><a href="<?php echo base_url('index.php/dashboard/logout');?>"><i class="fa fa-circle-o text-yellow"></i> <span>Log out</span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="<?php echo base_url('index.php/dashboard/barang/add');?>" class="small-box-footer">Tambahkan <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('index.php/dashboard/transaksi/add');?>" class="small-box-footer">Tambahkan <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                ...
                <a href="<?php echo base_url('index.php/dashboard/barang');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-red">
                ...
                <a href="<?php echo base_url('index.php/dashboard/transaksi');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
         </section>
