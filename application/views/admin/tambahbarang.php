...
<html>
  <head>
    ...
    <title>Tambah Barang - SI Indobayi</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url('dashboard/tambahbarang');?>"><i class="fa fa-circle-o"></i> Tambahkan Barang</a></li>
                <li><a href="<?php echo base_url('dashboard/tambahtransaksi');?>"><i class="fa fa-circle-o"></i> Tambahkan Transaksi</a></li>
              </ul>
            </li>
            <li class="treeview">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Tambahkan Barang</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="box box-primary">
                ...
                <?php echo form_open_multipart('TambahkanData/tambahbarang');?>
                  <div class="box-body">
                      <div class="row">
                        <div class="col-xs-3">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          ...
                          <input type="text" name="jumlahBarang" class="form-control" placeholder="Jumlah Stok Barang">
                        </div>
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="deskripsiBarang" rows="3" placeholder="Deskripsi Barang ..."></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-12">
                          <div class="form-group">
                            ...
                            <input type="file" name="gbrBarang">
